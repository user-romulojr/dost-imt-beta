    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-200">
            <div class="flex" id="wrapper" x-data="{ isOpen : true }">
                <div id="sidebar" class="h-screen overflow-y-auto bg-white transition-all duration-200 shadow"
                     :class="isOpen ? 'w-50' : 'w-0'">
                ...
                <div id="body" class="w-full h-screen overflow-y-auto transition-all duration-200">
                    <div class="w-full h-auto p-4 flex bg-dost-blue justify-between">
                        <button @click.prevent="isOpen = !isOpen">
                            <x-menu-icon class="block h-8 w-auto fill-current text-gray-800"/>
                        </button>
                        <!-- Settings Dropdown -->
